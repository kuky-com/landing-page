  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <main className="flex-grow flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8">
        ...
        <h3 class="font-lexend text-2xl sm:text-3xl md:text-2xl lg:text-[70px] font-extrabold leading-[1.1em] sm:leading-[86px] tracking-[0.002em] text-center mb-6 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-b from-[#686868] via-[#686868] to-[#202020] px-4 sm:px-0"><span class="mb-2 sm:mb-0 block leading-[1.2em]">Sign up for private beta access</span></h3>
